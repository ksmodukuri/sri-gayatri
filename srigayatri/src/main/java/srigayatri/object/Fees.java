...
public class Fees {
	...
	private int examFeesBal;
	
	private int totalBalFees;
	...
	public void setAdmissionBal(int admissionBal) {
		this.admissionBal = admissionBal;
	}
	...
	public int getExamFeesPaid() {
		return examFeesPaid;
	}

	public void setExamFeesPaid(int examFeesPaid) {
		this.examFeesPaid = examFeesPaid;
	}

	public int getExamFeesBal() {
		return examFeesBal;
	}

	public void setExamFeesBal(int examFeesBal) {
		this.examFeesBal = examFeesBal;
	}
	...
	public int getTotalBalFees() {
		return totalBalFees;
	}

	public void setTotalBalFees(int totalBalFees) {
		this.totalBalFees = totalFees - totalFeesPaid;
	}
	...
	public void setTermThreeBal(int termThreeBal) {
		this.termThreeBal = termThreeBal;
	}
	...
	public void setTransportationBal(int transportationBal) {
		this.transportationBal = transportationBal;
	}
