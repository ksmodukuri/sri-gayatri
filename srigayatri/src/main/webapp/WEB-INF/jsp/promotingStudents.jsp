						...
						<form role="search">
							<div class="row">
								...
								<label>To Class</label>
									<div class="input-group">
										<div class="input-group-item">
											<input
												class="form-control input-group-inset input-group-inset-after"
												placeholder="Search" type="text" id="toClass" /> <span
												class="input-group-inset-item input-group-inset-item-after">
											</span>
										</div>
									</div>
								...
								<div class="col" style="margin-top: 0.65cm">
									...
									&nbsp;
									<button class="btn btn-success" type="button" id="promotehBtn">
										Promote
			...
			<div class="container">
				...
				<use href="/images/icons/icons.svg#caret-double-l"></use>
					...
					<input type="hidden" value="10" id="selectedPageLimit"
						name="selectedPageLimit" /> <input type="hidden" value="showStudentsMarks"
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-success" data-dismiss="modal" onClick="javascript:location='promoteStudentsPage'">OK</button>
      </div> 
    </div>
  </div>
</div>
